...
public class FordCar implements ICar {
	...
	public void turnOn() throws InterruptedException {
		System.out.println("FordCar - The engine runs smoothly~F");
		Thread.sleep((long)(Math.random() * 500) + 500);	}

	@Override
	public void turnOff() throws InterruptedException {
		System.out.println("FordCar - The engine turns off correctly~F");
		Thread.sleep((long)(Math.random() * 500) + 500);	}
	...
	public void footBreak() throws InterruptedException {
		System.out.println("FordCar - The brakes operate correctly~F");
		Thread.sleep((long)(Math.random() * 500) + 500);	}
